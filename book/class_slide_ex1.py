...
x = opt_mod.addVar(name="x1", vtype=GRB.CONTINUOUS, lb=0)
y = opt_mod.addVar(name="x2", vtype=GRB.CONTINUOUS, lb=0)
z = opt_mod.addVar(name="x3", vtype=GRB.CONTINUOUS, lb=0)
w = opt_mod.addVar(name="x4", vtype=GRB.CONTINUOUS, lb=0)
...
c4 = opt_mod.addConstr(x + y + z + w == 80, name="c4")

opt_mod.optimize()  # solve the model
opt_mod.write("class_slide_ex1.lp")
